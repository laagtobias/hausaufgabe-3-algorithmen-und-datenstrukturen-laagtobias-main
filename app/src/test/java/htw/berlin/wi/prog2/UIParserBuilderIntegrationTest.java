...
public class UIParserBuilderIntegrationTest {
    ...
    //Erwartet: "In Ordnung. Deine Bowl mit [Lachs, Lachs, Mayo, Reis] kostet 2.70 Euro. Willst du die Bestellung abschliessen?"
    //Tatsächlich übergeben:
    //"Willkommen beim Bowl-Bot! Was möchtest du gerne bestellen?"
