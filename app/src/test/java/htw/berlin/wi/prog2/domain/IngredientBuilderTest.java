...
class IngredientBuilderTest {
    ...
    void testDifferentClasses() {
        ...
        Ingredient a = builder.setName("Wakame").setPrice("0.123").setCals(42).build(Ingredient.Category.TOPPING);
    ...
    void testSameProps() {
        IngredientBuilder builder = new IngredientBuilder();
        Ingredient a = builder.setName("Wakame").setPrice("0.01").setCals(900).build(Ingredient.Category.TOPPING);
        Ingredient b = builder.setName("Wakame").setPrice("0.01").setCals(900).build(Ingredient.Category.TOPPING);
    ...
    void testSimilarPrice() {
        IngredientBuilder builder = new IngredientBuilder();
        Ingredient a = builder.setName("Wakame ").setPrice("0.0100").setCals(900).build(Ingredient.Category.TOPPING);
        Ingredient b = builder.setName(" Wakame").setPrice("0.01").setCals(900).build(Ingredient.Category.TOPPING);
        assertEquals(a.equals(b), true);
        assertEquals(a.hashCode(), b.hashCode());
    }
